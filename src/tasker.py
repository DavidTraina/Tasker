...
def get_env_var(var_name):
    try:
        ...
        raise Exception(f'environment variable {var_name} should be set but isn\'t')
...
def delete(task_id):
    ...
    try:
        ...
        return 'Error deleting task from database'
...
def edit(task_id):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return 'Error editing task in database'
...
if __name__ == '__main__':
    ...
    )  # must use 0.0.0.0 instead of localhost
